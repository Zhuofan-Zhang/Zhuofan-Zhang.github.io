...
const StepsComponent: React.FC<Props> = ({setSelectedPage}: Props) => {
    return (
        <motion.div
            className="mx-auto w-5/6 gap-5 items-center justify-center md:flex md:h-full pt-20"
            initial="hidden"
            whileInView="visible"
            ...
            <Steps progressDot current={educationSteps.length} direction="horizontal" responsive={false} size="small"
